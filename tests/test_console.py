#!/usr/bin/python3
"""
The Unit test for console command interpreter
"""
import unittest
...
class TestConsole(unittest.TestCase):
    ...
    """Thi is the Unittest for command interpreter"""
    @classmethod
    def setUpClass(self):
        """Set up test"""
    ...
    def tearDownClass(self):
        """This will Remove temporary file (file.json) created as a result"""
        try:
            os.remove("file.json")
        except:
            pass

    """This will Check for Pep8 style conformance"""
    ...
    def test_destroy(self):
        """This will test cmd output: destroy"""
        with patch('sys.stdout', new=StringIO()) as fake_output:
